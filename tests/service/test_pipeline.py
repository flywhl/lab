...
def test_orders_dependent_experiments(pipeline_service):
    ...
    exp2 = Experiment(
        ...
        name="exp2",
        path=Path("exp2.py"),
        parameters={"input": ValueReference(owner=exp1, attribute="output")},
    )
...
def test_orders_chain_of_dependencies(pipeline_service):
    ...
    exp3 = Experiment(
        ...
        name="exp3",
        path=Path("exp3.py"),
        parameters={"input": ValueReference(owner=exp2, attribute="output")},
    )
...
def test_detects_circular_dependencies(pipeline_service):
    ...
    exp1.parameters["input"] = ValueReference(owner=exp2, attribute="output")
